...
import org.apache.activemq.artemis.core.config.ha.*;
...
public abstract class ClusterTestBase extends ActiveMQTestBase {
    ...
    private DistributedLockManagerConfiguration getOrCreatePluggableQuorumConfiguration() {
        ...
        try {
            pluggableQuorumConfiguration = new DistributedLockManagerConfiguration(null, Collections.singletonMap("locks-folder", temporaryFolder.newFolder("manager").toString()));
     ...
     * <br>
     * Use
     * {@link #setupClusterConnectionWithBackups(String, String, MessageLoadBalancingType, int, boolean, int, int[])}
     * to add it.
     *
     * @param node
     * @param primaryNode
